...
resource "sdwan_system_ipv4_device_access_feature" "system_ipv4_device_access_feature" {
  ...
  sequences = try(length(each.value.ipv4_device_access_policy.sequences) == 0, true) ? null : [for s in each.value.ipv4_device_access_policy.sequences : {
    ...
    destination_data_prefix_list_id     = try(local.ipv4_data_prefix_list_ids[s.match_entries.destination_data_prefix_list], null)
    ...
    source_data_prefix_list_id          = try(local.ipv4_data_prefix_list_ids[s.match_entries.source_data_prefix_list], null)
